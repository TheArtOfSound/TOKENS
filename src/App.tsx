  ...
  return (
    <>
      ...
      {route.name === 'home' && (
        ...
        {snapshot.profile ? <ProfileView profile={snapshot.profile} daily={snapshot.daily} integrity={snapshot.integrity} keyId={(snapshot as { signature?: { keyId?: string } }).signature?.keyId} /> : null}
