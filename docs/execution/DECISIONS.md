...
**Decision:** 62 tests across normalization/dedup, adversarial privacy, allowlist publication, JSON-Schema validation, compact history, and strangler equivalence. CI runs typecheck → tests → validate:data → build; any failure blocks deploy.
