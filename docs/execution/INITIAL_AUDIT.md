...
No test runner, no tests. **Fixed this session** (D7): 62 tests across normalization, dedup, privacy/redaction, allowlist publication, schema validation, history, and strangler equivalence.
